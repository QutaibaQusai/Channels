...
/// Main application widget for Channels app
class ChannelsApp extends ConsumerStatefulWidget {
  const ChannelsApp({super.key});

  @override
  ConsumerState<ChannelsApp> createState() => _ChannelsAppState();
}

class _ChannelsAppState extends ConsumerState<ChannelsApp> {
  @override
  void initState() {
    super.initState();
